                        ...
                        <table width="100%">
                            <tr>
                                <td align="center" style="width: 600px; max-width: 100%; padding: 10px; text-align:center !important">
                                        <span style="color: #696158; font-size: 20px; text-align: center !important;"> Hola, recientemente realizaste el proceso de compra en la tienda online de la Viña Hacienda San Juan, a continuación se detalla el pedido.<br>Tú número de pedido es <?=$resumenId?></span>
                                        <br>
                                </td>
                            </tr>       
                        </table>
